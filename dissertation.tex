...
\input{common/userdefs}         % Пользовательские определения
...
\include{Dissertation/chapters/01-architecture}     % Глава 1
\include{Dissertation/chapters/02-exp-na64}         % Глава 2
\include{Dissertation/chapters/03-implem}           % Глава 3
\include{Dissertation/chapters/04-result-prob}      % Глава 4
